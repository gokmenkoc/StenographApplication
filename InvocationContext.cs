...
namespace stenoapp
{
    public class InvocationContext
    {
        ...
        public IResponse Invoke<T>(string methodName, object instance, params object[] parameters)
        {
            try
            {
                LoggerContext.Log(MethodBase.GetCurrentMethod(), "Entering...");
            ...
            {
                LoggerContext.Log(MethodBase.GetCurrentMethod(), "Error: " + ex);

                return Response<T>.CreateFailureResponse(ex);
            }
            finally
            {
                LoggerContext.Log(MethodBase.GetCurrentMethod(), "Exiting...");
            }
        }
    }
